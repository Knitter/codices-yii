 ...
 * @var \Codices\View\Model\CollectionSearch $searchModel
 */
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => static function ($model) {
                        $url = Url::to(['collection/view', 'id' => $model->id]);
