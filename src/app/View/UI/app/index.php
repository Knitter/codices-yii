        ...
        <div class="bg-primary text-white rounded-4 p-5 text-center position-relative overflow-hidden">
            <div class="position-relative z-1">
                <h1 class="display-4 fw-bold mb-3">
                    ...
                    Welcome to <?php //= $applicationParameters->getName() ?>
                </h1>
                <p class="lead mb-4">
                    Your comprehensive digital library management system for books, e-books, and audiobooks
                </p>
                <div class="d-flex gap-3 justify-content-center flex-wrap">
                    <a href="<?php //= $urlGenerator->generate('item/create') ?>" class="btn btn-light btn-lg">
                        <i class="bi bi-plus-circle me-2"></i>Add New Book
                    </a>
                    <a href="<?php //= $urlGenerator->generate('item/index') ?>" class="btn btn-outline-light btn-lg">
    ...
    <div class="col-md-3 col-sm-6 mb-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body text-center">
                ...
                <a href="<?php //= $urlGenerator->generate('item/books') ?>" class="btn btn-outline-primary btn-sm">
    ...
    <div class="col-md-3 col-sm-6 mb-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body text-center">
                ...
                <a href="<?php //= $urlGenerator->generate('item/ebooks') ?>" class="btn btn-outline-success btn-sm">
                    View All <i class="bi bi-arrow-right ms-1"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-md-3 col-sm-6 mb-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body text-center">
                ...
                <a href="<?php //= $urlGenerator->generate('item/audiobooks') ?>" class="btn btn-outline-warning btn-sm">
                    View All <i class="bi bi-arrow-right ms-1"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-md-3 col-sm-6 mb-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-body text-center">
                ...
                <a href="<?php //= $urlGenerator->generate('item/index') ?>" class="btn btn-outline-info btn-sm">
                    View All <i class="bi bi-arrow-right ms-1"></i>
                </a>
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="card border-0 shadow-sm h-100 hover-lift">
                    <div class="card-body">
                        ...
                        <a href="<?php //= $urlGenerator->generate('item/create') ?>" class="btn btn-primary w-100">
            ...
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="card border-0 shadow-sm h-100 hover-lift">
                    <div class="card-body">
                        ...
                        <a href="<?php //= $urlGenerator->generate('item/search') ?>" class="btn btn-success w-100">
            ...
            <div class="col-lg-4 col-md-6 mb-3">
                <div class="card border-0 shadow-sm h-100 hover-lift">
                    <div class="card-body">
                        ...
                        <a href="<?php //= $urlGenerator->generate('author/index') ?>" class="btn btn-info w-100">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <div class="list-group-item border-0 px-0">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="<?php //= $urlGenerator->generate('author/index') ?>"
                    ...
                    <div class="list-group-item border-0 px-0">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="<?php //= $urlGenerator->generate('item/search') ?>" class="btn btn-sm btn-outline-info">
                                Explore
                            </a>
                        </div>
                    </div>
