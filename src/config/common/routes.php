...
use Codices\Controller\AccountController;
use Codices\Controller\AuthorController;
use Codices\Controller\BookController;
use Codices\Controller\CollectionController;
use Codices\Controller\FormatController;
use Codices\Controller\GenreController;
use Codices\Controller\ItemController;
use Codices\Controller\PublisherController;
use Codices\Controller\SeriesController;
use Codices\Controller\AppController;
...
return [
    Group::create()
        ->routes(
            // Site routes
            Route::get('/')->action([AppController::class, 'index'])->name('home'),
