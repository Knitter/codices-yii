...
final class Genre extends Model {
    ...
    /**
     * @param int                       $ownerId
     * @param \App\Model\Genre|null $genre
     * @param array                     $config
     */
    public function __construct(int $ownerId, \App\Model\Genre $genre = null, array $config = []) {
        $this->ownerId = $ownerId;
        $this->genre = new \App\Model\Genre();
