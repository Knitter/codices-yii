...
final class Author extends Model {
    ...
    /** @var \App\Model\Author|null */
    private ?\App\Model\Author $author;
    private int $ownerId;
    ...
    /**
     * @param int                        $ownerId
     * @param \App\Model\Author|null $author
     * @param array                      $config
     */
    public function __construct(int $ownerId, \App\Model\Author $author = null, array $config = []) {
        $this->ownerId = $ownerId;
        $this->author = new \App\Model\Author();
        if ($author) {
            $this->author = $author;
