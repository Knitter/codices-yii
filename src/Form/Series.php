...
final class Series extends Model {
    ...
    /** @var \App\Model\Series|null */
    private ?\App\Model\Series $series;
    private int $ownerId;
    ...
    /**
     * @param int                        $ownerId
     * @param \App\Model\Series|null $series
     * @param array                      $config
     */
    public function __construct(int $ownerId, \App\Model\Series $series = null, array $config = []) {
        $this->ownerId = $ownerId;
        $this->series = new \App\Model\Series();
        if ($series) {
            $this->series = $series;
