...
final class Collection extends Model {
    ...
    /** @var \App\Model\Collection|null */
    private ?\App\Model\Collection $collection;
    private int $ownerId;
    ...
    /**
     * @param int                            $ownerId
     * @param \App\Model\Collection|null $collection
     * @param array                          $config
     */
    public function __construct(int $ownerId, \App\Model\Collection $collection = null, array $config = []) {
