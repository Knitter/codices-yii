...
final class Publisher extends Model {
    ...
    /** @var \App\Model\Publisher|null */
    private ?\App\Model\Publisher $publisher;
    private int $ownerId;
    ...
    /**
     * @param int                           $ownerId
     * @param \App\Model\Publisher|null $publisher
     * @param array                         $config
     */
    public function __construct(int $ownerId, \App\Model\Publisher $publisher = null, array $config = []) {
        $this->ownerId = $ownerId;
        $this->publisher = new \App\Model\Publisher();
        if ($publisher) {
