...
source /codices/dev/vagrant/provision/common.sh
PHP_VERSION=8.4
...
ln -s /codices/dev/vagrant/xdebug.ini /etc/php/${PHP_VERSION}/mods-available/xdebug.ini
...
ln -s /codices/dev/vagrant/nginx/codices.conf /etc/nginx/sites-enabled/codices.conf
